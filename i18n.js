(function (global) {
  const resources = {
    ...
    en: {
      ...
      "稍后阅读": "Read later",
      "标记到期时间": "Marker expires at",
      "稍后阅读默认到期时间": "Default Read later expiration",
      "通过卡片快捷标记或新建收藏时，自动使用这个期限；单条网址仍可单独修改": "Use this duration for quick card markers and new bookmarks; individual websites can still override it",
      "1 天后": "After 1 day",
      "3 天后": "After 3 days",
      "7 天后": "After 7 days",
      "14 天后": "After 14 days",
      "30 天后": "After 30 days",
      "永不到期": "Never expires",
      "还没有稍后阅读的网址": "No websites marked for later yet",
      "编辑收藏并开启稍后阅读标记，可按需设置到期时间": "Edit a bookmark, enable Read later, and optionally set an expiration time",
      "标记完成": "Mark as complete",
      "完成": "Done",
      "已完成阅读": "Marked as completed",
      "工作效率": "Productivity",
      "技术开发": "Development",
      "设计灵感": "Design",
      "学习资料": "Learning",
